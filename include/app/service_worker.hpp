 ...
 *
 * ServiceWorker executes service operations in a background thread.
 * This header is separate from backend_service.hpp to allow direct
 * use of nlohmann::json without Qt MOC compatibility issues.
 */
