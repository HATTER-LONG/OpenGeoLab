 ...
 *
 * These maps are built by GeometryRenderBuilder and consumed by
 * RenderSceneImpl (processHover / processPicking) to resolve edges to wires
 * and wires to faces. Mesh line picks are resolved directly via
 * MeshDocument since Line elements are proper MeshElement objects.
