...
private:
     ...
     * @param entityUid Entity UID to encode
     * @param entityType Entity type to encode
     * @param r Output red component
     * @param g Output green component
     * @param b Output blue component
     * @param a Output alpha component
     */
    static void encodeEntityId(Geometry::EntityUID entityUid,
     ...
     * @param entityUid Output entity UID
     * @param entityType Output entity type
...
private:
    ...
    std::unique_ptr<QOpenGLShaderProgram> m_idShader; ///< Shader for ID buffer rendering
