 ...
 */
struct RenderEdge {
    std::vector<Point3D> m_points;          ///< Polyline points along the edge
    RenderColor m_color{0.1f, 0.1f, 0.1f};  ///< Edge color (default: dark gray)
    EntityId m_entityId{INVALID_ENTITY_ID}; ///< Source entity ID for picking
...
struct RenderFace {
    ...
    EntityId m_entityId{INVALID_ENTITY_ID}; ///< Source face entity ID for picking
...
struct PartRenderData {
    EntityId m_partEntityId{INVALID_ENTITY_ID}; ///< Part entity ID
