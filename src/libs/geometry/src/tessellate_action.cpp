        ...
        {"params",
         {{"shapeId",
          ...
          {"linearDeflection",
           {{"type", "number"},
            {"required", false},
            {"description", "Tessellation linear deflection (0 or absent = auto-calculate)"}}},
          {"angularDeflection",
           {{"type", "number"},
            {"required", false},
            {"description", "Tessellation angular deflection (default 0.25)"}}},
          {"tessRatio",
           {{"type", "number"},
            {"required", false},
            {"description", "Quality multiplier for auto-calculated deflection (default 1.0)"}}}}},
        {"returns",
         {{"ok",
