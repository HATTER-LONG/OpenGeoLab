                    ...
                    Column {
                        ...
                        Repeater {
                            ...
                            delegate: Components.ActionButton {
                                ...
                                hoverBorderOverride: modelData.hoverAccent ? panel.theme.accentHoverBorder(modelData.hoverAccent) : "transparent"
                                buttonText: {
                                    ...
                                    if (modelData.key === "switchLanguage")
                                        return TranslationManager.currentLanguage === "zh_CN" ? qsTr("Switch to English") : qsTr("Switch to Chinese");
