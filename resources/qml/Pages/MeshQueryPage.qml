...
FunctionPageBase {
    ...
    /// Query results model returned by backend action `query_mesh_info`
            ...
            ListView {
                ...
                delegate: Rectangle {
                    ...
                    Column {
                        ...
                        Label {
                            text: row.modelData.nodeCount !== undefined ? (qsTr("Node Count: ") + row.modelData.nodeCount) : ""
                            visible: row.modelData.nodeCount !== undefined
                            font.pixelSize: 10
                            color: Theme.textSecondary
                            elide: Text.ElideRight
                        }
