...
function(opengeolab_add_module target)
  ...
  if(NOT MODULE_ALIAS_NAME)
    message(FATAL_ERROR "opengeolab_add_module requires ALIAS_NAME for target ${target}")
  endif()
  ...
  set(module_generated_include_dir "${CMAKE_CURRENT_BINARY_DIR}/generated/include")
  set(
    module_generated_export_header
    "${module_generated_include_dir}/opengeolab/${module_alias_name_lower}/${MODULE_ALIAS_NAME}Export.hpp"
  )
  set(module_export_macro_name "OPENGEOLAB_${module_alias_name_upper}_EXPORT")
  set(module_static_define_name "OPENGEOLAB_${module_alias_name_upper}_STATIC_DEFINE")
  file(MAKE_DIRECTORY "${module_generated_include_dir}/opengeolab/${module_alias_name_lower}")
  generate_export_header(
    ${target}
    EXPORT_FILE_NAME "${module_generated_export_header}"
    EXPORT_MACRO_NAME ${module_export_macro_name}
    STATIC_DEFINE ${module_static_define_name}
  )
  ...
  if(module_library_type STREQUAL "STATIC")
    target_compile_definitions(${target} PUBLIC ${module_static_define_name})
  endif()
...
function(opengeolab_copy_runtime_dlls target)
  if(NOT TARGET ${target})
    message(FATAL_ERROR "opengeolab_copy_runtime_dlls requires an existing target: ${target}")
  endif()
