...
When a skill tells you to set `model` on Copilot CLI's `task` tool, only use:

- `gpt-5.4` for scoped implementation and debugging agents
- `claude-opus-4.6` for review, planning, architecture, and escalation agents

Do not use other model IDs in these skill workflows.
